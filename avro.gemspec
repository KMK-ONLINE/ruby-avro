...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_fingerprints.rb", "test/test_io.rb", "test/test_datafile.rb", "test/test_schema_normalization.rb", "test/test_help.rb", "test/test_socket_transport.rb", "test/test_schema.rb", "test/test_protocol.rb"]
